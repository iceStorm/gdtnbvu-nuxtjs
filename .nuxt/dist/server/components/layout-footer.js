...
installComponents(component, {ColorModeSwitcher: function () { return Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 105)).then(function(m) { return m['default'] || m }) },LanguageSwitcher: function () { return Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 67)).then(function(m) { return m['default'] || m }) }})
